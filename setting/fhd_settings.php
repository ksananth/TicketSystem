...
<head>
<meta charset="utf-8">
	<title>Ticket System Settings</title>
<?php
...
<a href="fhd_settings_action.php?type=1" class="btn btn-default btn-sm"><i class="fa fa-cog"></i> Category</a> 
<a href="fhd_settings_action.php?type=3" class="btn btn-default btn-sm"><i class="fa fa-cog"></i>Sub-Category</a> 
<a href="fhd_settings_action.php?type=2" class="btn btn-default btn-sm"><i class="fa fa-cog"></i> Request Types</a> 
<a href="fhd_settings_action.php?type=4" class="btn btn-default btn-sm"><i class="fa fa-cog"></i>Department</a> 
<a href="fhd_settings_action.php?type=5" class="btn btn-default btn-sm"><i class="fa fa-cog"></i>Course</a> 
